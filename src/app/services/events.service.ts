...
export class EventsService {
  ...
  getEventDetails(eventId: any) {//: Promise<Entry<any>>{
    return this.http.post<{token: string, expiresIn: number, auth: any, error: any}>("https://volida-be.herokuapp.com/api/get-event-details", {id:eventId, paymentId:localStorage.getItem('_id')});
    // return this.client.getEntries(Object.assign({
    // content_type: environment.contentfulVolidaEvents.contentTypeIds.product
    // }, {'sys.id': eventId}))
