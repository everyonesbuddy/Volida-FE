...
export class EventsService {
  ...
  getContentCallCheck(eventId: any){//: Promise<Entry<any>> {
    return this.http.post<{token: string, expiresIn: number, auth: any, error: any}>("https://volida-be.herokuapp.com/api/getContentCallCheck", {id:eventId});
  };
}
